...
/srv/mist-architect/
  ...
  current-preview -> /srv/mist-architect/releases/20260501111326-c3d49c3
  current-production -> /srv/mist-architect/releases/20260501111326-c3d49c3
```

Latest preview release:

```text
20260501111326-c3d49c3
```
...
```text
/srv/mist-architect/releases/20260501111326-c3d49c3/server.js
```
...
- `/srv/mist-architect/current-production` points to `20260501111326-c3d49c3`.
